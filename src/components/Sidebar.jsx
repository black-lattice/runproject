import { ChevronRight, RefreshCw, Trash2, FolderOpen, Plus, Box } from 'lucide-react';
							...
							<div key={index} className='group'>
								...
								<div className='flex items-center gap-1 mb-1 px-2 group-hover:bg-gray-50/50 rounded-lg transition-colors py-1'>
									<button
										...
										<ChevronRight
											className={`w-3.5 h-3.5 transition-transform duration-200 ${collapsedWorkspaces[index] ? '' : 'rotate-90'
												}`}
										/>
									</button>
								...
								{/* Projects List */}
								<div
									className={`space-y-0.5 ml-2 pl-3 border-l border-gray-100 transition-all duration-300 ease-in-out overflow-hidden ${collapsedWorkspaces[index]
											? 'max-h-0 opacity-0'
